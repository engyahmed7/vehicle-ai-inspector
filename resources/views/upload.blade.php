                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="container">
                        ...
                        <div class="form-container">
                            <form action="{{ route('upload.analyze') }}" method="POST" enctype="multipart/form-data"
                                id="uploadForm">
                                @csrf
                                ...
                                <div class="upload-grid">
                                    ...
                                    <div class="upload-item type-exterior" data-type="front">
                                        ...
                                        <input type="file" name="images[front]" id="front" class="file-input"
                                            accept="image/*">
                                    ...
                                    <div class="upload-item type-exterior" data-type="rear">
                                        ...
                                        <input type="file" name="images[rear]" id="rear" class="file-input"
                                            accept="image/*">
                                        <div class="file-name"></div>
                                    </div>
                                    ...
                                    <div class="upload-item type-exterior" data-type="left">
                                        ...
                                        <input type="file" name="images[left]" id="left" class="file-input"
                                            accept="image/*">
                                        <div class="file-name"></div>
                                    </div>
                                    ...
                                    <div class="upload-item type-exterior" data-type="right">
                                        ...
                                        <input type="file" name="images[right]" id="right" class="file-input"
                                            accept="image/*">
                                        <div class="file-name"></div>
                                    </div>
                                    ...
                                    <div class="upload-item type-interior" data-type="interior_front">
                                        ...
                                        <input type="file" name="images[interior_front]" id="interior_front"
                                    ...
                                    <div class="upload-item type-interior" data-type="interior_rear">
                                        ...
                                        <input type="file" name="images[interior_rear]" id="interior_rear"
                                            class="file-input" accept="image/*">
                                        <div class="file-name"></div>
                                    </div>
                                    ...
                                    <div class="upload-item type-detail" data-type="dashboard">
                                        ...
                                        <input type="file" name="images[dashboard]" id="dashboard" class="file-input"
                                            accept="image/*">
                                        <div class="file-name"></div>
                                    </div>
                                    ...
                                    <div class="upload-item type-detail" data-type="vin_area">
                                        ...
                                        <input type="file" name="images[vin_area]" id="vin_area"
                                            class="file-input" accept="image/*">
                                        <div class="file-name"></div>
                                    </div>
                                    ...
                                    <div class="upload-item type-detail" data-type="license_close">
                                        ...
                                        <input type="file" name="images[license_close]" id="license_close"
                                            class="file-input" accept="image/*">
                                        <div class="file-name"></div>
                                    </div>
                                    ...
                                    <div class="upload-item type-detail" data-type="insurance_card">
                                        ...
                                        <input type="file" name="images[insurance_card]" id="insurance_card"
                                            class="file-input" accept="image/*">
                                        <div class="file-name"></div>
                                    </div>
                                    ...
                                    <div class="upload-item type-detail" data-type="mvr">
                                        ...
                                        <input type="file" name="images[mvr]" id="mvr" class="file-input"
                                            accept="image/*">
                                        <div class="file-name"></div>
                                    </div>
                                </div>
