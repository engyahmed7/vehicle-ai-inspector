...
{{-- <body class="bg-gray-100 min-h-screen"> --}}
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-md mx-auto bg-white rounded-lg shadow-lg p-6">
            ...
            @if(auth()->user()->kyc_status !== 'approved')
                <div id="kyc-form">
                    <button id="start-kyc" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-lg transition duration-200">
                ...
                <div id="kyc-pending" class="hidden">
                    ...
                    <button id="check-status" class="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-4 rounded-lg transition duration-200">
                ...
                startKycBtn.addEventListener('click', async function() {
                    ...
                    try {
                        ...
                        if (data.data && data.data.id) {
                            ...
                            const sessionUrl = `https://withpersona.com/verify?inquiry-id=${data.data.id}`;
            ...
            async function checkVerificationStatus() {
                ...
                try {
                    ...
                    if (status && status !== 'created' && status !== 'started') {
                        ...
                        alert('Verification still in progress. Please complete it in the Persona tab and try again.');
                    }
                } catch (error) {
